...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint="/mnt/data/pretrained/mmdetection/yolox_l_8x8_300e_coco_20211126_140236-d3bd2b23.pth",
        ),
    ),
    # backbone=dict(
    #     type='CSPDarknet',
    ...
    head=dict(
        ...
        prior_generator=dict(
            type="MlvlPointGenerator", centralize_points=True, strides=[16, 32]
        ),
        dcc_cfg=dict(
            in_channels=512,
            feat_channels=128,
        ...
        loss_oks=dict(
            type="OKSLoss", reduction="none", metainfo=metafile, loss_weight=30.0
        ),
        loss_vis=dict(
            type="BCELoss", use_target_weight=True, reduction="mean", loss_weight=1.0
        ),
        loss_mle=dict(
            type="MLECCLoss",
            use_target_weight=True,
